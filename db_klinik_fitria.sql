...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2022 at 08:16 AM
...
('P00004', 'Yuni Ardi Eliana', 'Pekalongan, Jawa Tengah', '2001-01-01', 23213213),
('P00005', 'Muhammad Hussein Arrafat', 'Surakarta', '2002-02-02', 21313123),
('P00006', 'Muhammad Syarifudin Effendi', 'Surakarta, Bekonang', '2002-02-05', 2147483647),
('P00007', 'Muhammad Aqil Syafiq', 'Pekanbaru', '2002-09-18', 2113133213),
('P00008', 'Hada Hidayat', 'Sukoharjo', '1999-04-21', 2147483647);
...
ALTER TABLE `rawatobat`
  ...
  ADD CONSTRAINT `rawatobat_ibfk_2` FOREIGN KEY (`idrawat`) REFERENCES `rawat` (`idrawat`) ON DELETE CASCADE ON UPDATE CASCADE;
